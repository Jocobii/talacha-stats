-- T_VC.1: Tabla de rentas directas de canchas (fuera de torneos)
-- Gestiona el uso comercial de la cancha en huecos entre jornadas de liga.
...
ALTER TABLE "venue_rentals" ADD CONSTRAINT "venue_rentals_venue_id_venues_id_fk"
	FOREIGN KEY ("venue_id") REFERENCES "public"."venues"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
CREATE INDEX "vr_venue_idx" ON "venue_rentals" USING btree ("venue_id");
--> statement-breakpoint
CREATE INDEX "vr_start_at_idx" ON "venue_rentals" USING btree ("start_at");
--> statement-breakpoint
