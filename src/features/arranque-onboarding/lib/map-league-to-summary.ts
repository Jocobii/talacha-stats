/**
 * features/arranque-onboarding/lib/map-league-to-summary.ts
 * Mapper puro DTO (QuickCreatedLeague) → ViewModel (CreatedLeagueView) para el
 * contexto mostrado en los pasos 2/3/4 del wizard (§19).
 */
