...
function checkDeltaSpike(
	...
	return {
		...
		context: {
			...
			threshold:
				level === "critical" ? THRESHOLDS.deltaSpikeCritical : THRESHOLDS.deltaSpikeWarning,
		},
	};
}
...
function checkZscore(
	...
	return {
		...
		context: {
			...
			threshold: level === "critical" ? THRESHOLDS.zscoreCritical : THRESHOLDS.zscoreWarning,
		},
	};
}
...
function checkCrossValidation(
	...
	const level: AnomalyLevel = ratio > THRESHOLDS.crossValCriticalFactor ? "critical" : "warning";
...
function checkGoalsPerGame(row: GoleadoresRow): AnomalyFlag | null {
	...
	const level: AnomalyLevel = ratio > THRESHOLDS.goalsPerGameCritical ? "critical" : "warning";
	...
	return {
		...
		context: {
			...
			threshold:
				level === "critical" ? THRESHOLDS.goalsPerGameCritical : THRESHOLDS.goalsPerGameWarning,
		},
	};
}
