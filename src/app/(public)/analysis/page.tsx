				...
				<div className="flex gap-2 mb-3 flex-wrap">
					{team.attackRank !== null &&
						(() => {
							...
							const [label, cls] =
								r <= Math.ceil(t / 3)
									? ["Ataque fuerte", "bg-green-950 text-green-400 border-green-900"]
									: r <= Math.ceil((t * 2) / 3)
										? ["Ataque regular", "bg-yellow-950 text-yellow-400 border-yellow-900"]
					...
					{team.defenseRank !== null &&
						(() => {
							...
							const [label, cls] =
								r <= Math.ceil(t / 3)
									? ["Defensa sólida", "bg-green-950 text-green-400 border-green-900"]
									: r <= Math.ceil((t * 2) / 3)
										? ["Defensa regular", "bg-yellow-950 text-yellow-400 border-yellow-900"]
