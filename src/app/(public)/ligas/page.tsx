...
export const metadata: Metadata = {
  ...
  description: "Encuentra tu liga de fútbol amateur. Tablas de posiciones, goleadores y estadísticas de todas las organizaciones.",
};
      ...
      <header className="relative px-5 pt-8 pb-0 max-w-lg mx-auto w-full overflow-hidden">
        <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
          <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
            <circle cx="88%" cy="50%" r="80" fill="none" stroke="#00E676" strokeWidth="1" opacity="0.07" />
            <circle cx="88%" cy="50%" r="40" fill="none" stroke="#00E676" strokeWidth="0.8" opacity="0.05" />
          </svg>
          <div style={{
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <ArrowRight size={16} strokeWidth={2} className="text-ink-3 group-hover:text-brand transition-colors shrink-0" />
      </div>
        ...
        {org.leagues.map((league) => (
          ...
          >
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span className="text-sm font-semibold text-ink truncate">{titleCase(league.name)}</span>
