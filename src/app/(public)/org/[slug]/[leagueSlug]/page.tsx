    ...
    <div className="text-ink flex flex-col flex-1 bg-pitch">
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="text-ink-3 text-sm mt-1">
                {league.season}
                {jornada && (
                  <span className="ml-2 text-brand font-semibold">· J{jornada}</span>
                )}
              </p>
            </div>
      ...
      <div className="flex-1 bg-surface rounded-t-3xl px-4 pt-5 pb-16">
        <div className="max-w-lg mx-auto space-y-6">
          ...
          {/* ── Tabla de posiciones ── */}
          <section>
            <SectionHeader icon={<Trophy size={16} strokeWidth={2} className="text-brand" />} title="Posiciones" />
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center min-w-0">
                        <span className={`text-sm font-semibold truncate ${isTop3 ? "text-ink" : "text-ink-2"}`}>
                          {row.team.name}
                        </span>
                      </div>
                      ...
                      <span className={`text-sm font-black text-right self-center ${isTop3 ? "text-brand" : "text-ink"}`}>
                        {row.points}
                      </span>
                    </div>
                  );
          ...
          {/* ── Goleadores ── */}
          <section>
            <SectionHeader icon={<Target size={16} strokeWidth={2} className="text-brand" />} title="Goleadores" />
