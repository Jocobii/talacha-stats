...
export default function HeroCard() {
  ...
  const badges = [
    { label: "Artillero", Icon: Flame, color: "text-orange-400", bg: "bg-orange-400/10 border-orange-400/20", delay: "1.6s" },
    { label: "Racha 5+", Icon: Star, color: "text-yellow-400", bg: "bg-yellow-400/10 border-yellow-400/20", delay: "1.75s" },
    { label: "Top Ciudad", Icon: Trophy, color: "text-brand", bg: "bg-brand/10 border-brand/20", delay: "1.9s" },
  ];
  ...
  return (
    ...
    >
      <div className="bg-surface border border-line rounded-2xl overflow-hidden shadow-2xl">
        ...
        >
          {[
            { label: "Goles", value: goals, icon: <Flame size={12} strokeWidth={2} className="text-brand" /> },
            { label: "Partidos", value: games, icon: <BarChart3 size={12} strokeWidth={2} className="text-ink-3" /> },
            { label: "Ligas", value: leagues, icon: <Star size={12} strokeWidth={2} className="text-ink-3" /> },
        ...
        >
          ...
          <span className="font-display font-black text-2xl text-brand leading-none">
            #8
          </span>
        </div>
