...
import {
  BarChart3, Trophy, Users, Zap, MapPin,
    ...
    <div className="text-ink flex flex-col">
      ...
      <section className="px-5 py-20 flex flex-col items-center text-center border-b border-line">
        ...
        <h1 className="font-display font-black text-5xl sm:text-7xl uppercase leading-[0.9] tracking-tight max-w-2xl">
          Por primera vez,<br />
          Tijuana sabrá quién es<br />
          <span className="text-brand">el mejor.</span>
        </h1>

        <p className="text-ink-2 text-base sm:text-lg leading-relaxed max-w-lg mx-auto mt-7">
          TalachaStats es la primera plataforma de estadísticas para fútbol
          amateur que conecta <strong className="text-ink">todas las ligas de la ciudad</strong> en
          un solo perfil por jugador.
        </p>
      </section>
      ...
      <section className="px-5 py-16 max-w-3xl mx-auto w-full">
        ...
        <h2 className="font-display font-black text-3xl sm:text-4xl uppercase leading-tight mb-6">
          Llevas años jugando.<br />
          <span className="text-ink-2">Nadie lleva la cuenta.</span>
        </h2>
        <p className="text-ink-2 leading-relaxed text-sm sm:text-base max-w-xl">
          En el fútbol amateur cada liga vive en su propia burbuja. Los goles que
          metiste el lunes no cuentan en la liga del martes. No hay un historial,
          no hay un perfil, no hay forma de saber quién es realmente el mejor
          jugador de la ciudad. Eso hasta ahora.
        </p>
      </section>
      ...
      <section className="bg-surface border-y border-line px-5 py-16">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-bold text-brand uppercase tracking-widest mb-4">Qué es TalachaStats</p>
      ...
      <section className="bg-surface border-y border-line px-5 py-16">
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row gap-10 items-start">
          <div className="flex-1">
            <p className="text-xs font-bold text-brand uppercase tracking-widest mb-4">Nuestra visión</p>
            ...
            <p className="text-ink-2 text-sm leading-relaxed max-w-md">
              Empezamos en Tijuana porque es nuestra ciudad y porque tiene una
              escena de fútbol amateur vibrante que merece ser documentada.
              El objetivo es que cada liga que se sume haga el ranking más
              completo y más competitivo — hasta que no haya duda de quién
              es el mejor jugador amateur de la ciudad.
            </p>
            <p className="text-ink-2 text-sm leading-relaxed max-w-md mt-4">
              Después de Tijuana, cualquier ciudad. El modelo es el mismo:
              un Excel semanal, un perfil por jugador, un ranking que lo dice todo.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4 shrink-0">
            {[
              ...
              <div key={label} className="bg-surface-2 border border-line rounded-xl px-6 py-4 text-center min-w-[140px]">
                <p className="font-display font-black text-3xl text-brand">{value}</p>
                <p className="text-ink-3 text-xs font-semibold uppercase tracking-wide mt-1">{label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-surface-2 border border-brand/20 rounded-2xl px-7 py-10 flex flex-col sm:flex-row items-start sm:items-center gap-7">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-xs font-bold text-brand uppercase tracking-widest">Para organizadores</p>
            </div>
            ...
            <p className="text-ink-2 text-sm leading-relaxed max-w-sm">
              Activa TalachaStats en tu liga. Sin cambiar tu flujo de trabajo —
              solo súbenos tu Excel de cada semana y nosotros hacemos el resto.
              Es gratis mientras estamos en demo.
            </p>
          </div>
        ...
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-ink-3 text-xs">
              Contenido, stats destacadas y novedades de la app.
            </p>
          </div>
