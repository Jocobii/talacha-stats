			...
			<div className="bg-gray-900 text-white rounded-2xl p-6 sm:p-8">
				<div className="flex flex-col sm:flex-row sm:items-center gap-6">
					...
					<div className="flex-1 min-w-0">
						...
						{profile.phone && <p className="text-gray-400 text-sm mt-1">{profile.phone}</p>}
					</div>
					...
					{hasStats && (
						<div className="text-center sm:text-right shrink-0">
							{g.totalMatches > 0 ? (
								...
								<>
									<p className="text-5xl font-black text-green-400 leading-none">{g.totalGoals}</p>
	...
	return (
		<div className="bg-white rounded-xl shadow border-t-4 border-green-500 p-5 space-y-4">
			...
			<div className="flex items-start justify-between gap-2">
				<div>
					<p className="font-bold text-gray-900 text-base leading-tight">{l.leagueName}</p>
